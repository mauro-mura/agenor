 ...
 * <p>Responsibilities:
 * <ol>
 *   <li>{@link #buildFunctionDefinitions()} — converts {@link dev.agenor.core.mcp.McpTool}s
...
public class McpFunctionAdapter {
    ...
    private FunctionDefinition toFunctionDefinition(dev.agenor.core.mcp.McpTool tool) {
