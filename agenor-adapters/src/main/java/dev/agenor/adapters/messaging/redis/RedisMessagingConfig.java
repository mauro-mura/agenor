 ...
 * @param consumerGroupPrefix     Prefix for Redis consumer group and key names (default: {@code agenor})
...
public record RedisMessagingConfig(
    ...
    public RedisMessagingConfig {
        ...
        if (consumerGroupPrefix == null || consumerGroupPrefix.isBlank()) consumerGroupPrefix = "agenor";
