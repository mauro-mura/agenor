 ...
 *
 * <p>The scheduler inspects this hint instead of relying on {@link dev.agenor.core.BehaviorType}
...
public enum SchedulingHint {
     ...
     * Equivalent to {@link dev.agenor.core.BehaviorType#ONE_SHOT} scheduling semantics.
     ...
     * Equivalent to {@link dev.agenor.core.BehaviorType#CYCLIC} scheduling semantics.
