 ...
 *
 * <p>Implementations use {@link dev.agenor.core.directory.AgentResolver} to translate
 * {@link dev.agenor.core.Message#receiverId()} to a transport endpoint, then route the
 * message accordingly. If the agent cannot be resolved, the returned future completes
 * exceptionally with {@link dev.agenor.core.exceptions.AgentNotFoundException}.
 *
 * @since 0.20.0
 * @see DirectReceiver
...
public interface DirectMessenger {
     ...
     *         completes exceptionally with {@link dev.agenor.core.exceptions.AgentNotFoundException}
