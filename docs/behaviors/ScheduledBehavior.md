...
**ScheduledBehavior** provides cron-like scheduling capabilities for Agenor agents, enabling time-based task execution with full timezone support, missed execution handling, and comprehensive metrics.
