...
class AgenorConfigurationTest {
    ...
    class RuntimeConfigTests {
        ...
        void defaultsShouldSetExpectedValues() {
            AgenorConfiguration.RuntimeConfig rc = AgenorConfiguration.RuntimeConfig.defaults();

            assertThat(rc.name()).isEqualTo("agenor-runtime");
        ...
        void nullNameShouldFallBack() {
            var rc = new AgenorConfiguration.RuntimeConfig(null, null, null);
        ...
        void explicitValuesShouldBePreserved() {
            var rc = new AgenorConfiguration.RuntimeConfig("my-runtime", "production", null);
        ...
        void propertiesMapShouldBeImmutable() {
            var rc = new AgenorConfiguration.RuntimeConfig("n", "e", Map.of("k", "v"));
    ...
    class AgentsConfigTests {
        ...
        void defaultsShouldEnableAutoDiscovery() {
            AgenorConfiguration.AgentsConfig ac = AgenorConfiguration.AgentsConfig.defaults();
        ...
        void basePackageShouldBeIncludedInScanPackages() {
            var ac = new AgenorConfiguration.AgentsConfig(true, "com.example", null, null, null);
        ...
        void scanPackagesShouldBeIncluded() {
            var ac = new AgenorConfiguration.AgentsConfig(true, null, null,
        ...
        void scanPathsShouldBeMerged() {
            var ac = new AgenorConfiguration.AgentsConfig(true, null,
        ...
        void allSourcesShouldBeMergedWithoutDuplicates() {
            var ac = new AgenorConfiguration.AgentsConfig(
                    true,
                    "com.base",
                    new String[]{"com.path"},
                    List.of("com.pkg"),
        ...
        void nullElementInScanPackagesShouldThrow() {
            ...
            assertThatThrownBy(() -> new AgenorConfiguration.AgentsConfig(
        ...
        void blankBasePackageShouldBeIgnored() {
            var ac = new AgenorConfiguration.AgentsConfig(true, "   ", null, null, null);
        ...
        void scanPackagesListShouldBeImmutable() {
            var ac = new AgenorConfiguration.AgentsConfig(true, "com.base", null, null, null);
        ...
        @DisplayName("properties map should be immutable")
        void propertiesMapShouldBeImmutable() {
            var ac = new AgenorConfiguration.AgentsConfig(true, null, null, null, Map.of("k", "v"));
    ...
    class MessagingConfigTests {
        ...
        void defaultsShouldSetInmemoryProvider() {
            var mc = AgenorConfiguration.MessagingConfig.defaults();
        ...
        void nullPropertiesShouldDefaultToEmpty() {
            var mc = new AgenorConfiguration.MessagingConfig("kafka", null);
    ...
    class DirectoryConfigTests {
        ...
        void defaultsShouldSetLocalProvider() {
            var dc = AgenorConfiguration.DirectoryConfig.defaults();
    ...
    class SchedulerConfigTests {
        ...
        void defaultsShouldConfigureSimpleScheduler() {
            var sc = AgenorConfiguration.SchedulerConfig.defaults();
    ...
    void nullSubConfigsShouldFallBackToDefaults() {
        var config = new AgenorConfiguration(null, null, null, null, null);
