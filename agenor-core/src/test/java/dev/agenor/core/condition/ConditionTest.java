package dev.agenor.core.condition;
...
/**
 * Comprehensive test coverage for Condition interface (agenor-core module)
 */
...
class ConditionTest {
    ...
    static class TestAgent implements Agent {
        ...
        @Override
        public dev.agenor.core.messaging.MessageDispatcher getMessageDispatcher() {
            return null;
        }
    }
}
