...
/**
 * No-op implementation of {@link AgenorTelemetry} that produces zero overhead.
 *
 ...
 * @since 0.19.0
 */
public final class NoopAgenorTelemetry implements AgenorTelemetry {

    /** Shared singleton instance. */
    static final NoopAgenorTelemetry INSTANCE = new NoopAgenorTelemetry();
