package dev.jentic.examples.hitl;
...
import dev.jentic.runtime.hitl.LoggingApprovalNotifier;
...
public class HitlExample {
    ...
    static class OperatorAgent extends BaseAgent {
        ...
        private void reviewPending() {
            List<dev.jentic.core.hitl.ApprovalRequest> pending = gate.getPendingRequests();
            if (pending.isEmpty()) return;

            // Simulate operator reaction time: decide after the first poll finds requests
            for (dev.jentic.core.hitl.ApprovalRequest req : pending) {
