...
class JenticHealthIndicatorTest {
    ...
    private static JenticRuntime runningRuntimeMock(int total, int running) {
        ...
        dev.agenor.core.JenticConfiguration config = mock(dev.agenor.core.JenticConfiguration.class);
        dev.agenor.core.JenticConfiguration.RuntimeConfig rc =
                new dev.agenor.core.JenticConfiguration.RuntimeConfig("test-runtime", "test", null);
